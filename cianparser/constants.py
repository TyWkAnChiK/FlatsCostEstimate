...
DEFAULT_PATH = "/cat.php?acontext=доли%7Cдолю%7Cдоля&deal_type=sale&engine_version=2&object_type%5B0%5D=1&offer_type=flat&p={}&region=1"
REGION_PATH = "&region=1"
OFFER_TYPE_PATH = "&offer_type={}"
RENT_PERIOD_TYPE_PATH = "&type={}"
DEAL_TYPE_PATH_SALE = "&deal_type=sale"
OBJECT_TYPE_PATH_DEFAULT = "&object_type%5B0%5D=1"
...
DEFAULT_FILTER = FLAT_SHARE_PATH.format(2) + "&demolished_in_moscow_programm=0"
